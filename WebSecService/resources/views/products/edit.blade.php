    ...
    <div class="row mb-2">
        ...
        <div class="col-6">
            ...
            <div class="input-group">
                <input type="file" class="form-control" name="photo_file" id="photo_file" accept="image/*">
                <input type="hidden" name="photo" value="{{$product->photo}}">
            </div>
            @if($product->photo)
            <div class="mt-2">
                <small>Current photo: {{$product->photo}}</small>
                <img src="{{asset('public/images/'.$product->photo)}}" alt="Product Image" class="img-thumbnail mt-2" style="max-height: 100px;">
            </div>
            @endif
        </div>
    </div>
